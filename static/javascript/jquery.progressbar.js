	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				width			: 120,											// Width of the progressbar - don't forget to adjust your image too!!!												// Image to use in the progressbar. Can be a single image too: '/static/images/progressbg_green.gif'
